...
import com.example.EmployeeExamProject.Employee;
import com.example.EmployeeExamProject.EmployeeRepository;
import com.example.EmployeeExamProject.EmployeeExamProjectApplication;
...
public class EmployeeExamProjectApplication implements CommandLineRunner{
	...
	public static void main(String[] args) {
		SpringApplication.run(EmployeeExamProjectApplication.class, args);
	}
	@Autowired
